...
interface TestCaseListProps {
  ...
  isDarkMode: boolean;
  onFormViewChange?: (isInForm: boolean) => void;
}

type ViewMode = 'list' | 'create' | 'edit';

const TestCaseList = forwardRef<any, TestCaseListProps>(
  ({ projectId, onTestCaseSelect, onBackToProjects, isDarkMode, onFormViewChange }, ref) => {
    ...
    const handleCreateClick = () => {
      ...
      setViewMode('create');
      if (onFormViewChange) onFormViewChange(true);
    };
    ...
    const handleCancel = () => {
      setViewMode('list');
      setSelectedTestCase(null);
      if (onFormViewChange) onFormViewChange(false);
    };
